...
function PracticeSection() {
  ...
  const practiceQueue = useSelector((s) => s.app.practiceQueue)
  const practiceIndex = useSelector((s) => s.app.practiceIndex)
  const correctCount = useSelector((s) => s.app.correctCount)
  const wrongCount = useSelector((s) => s.app.wrongCount)
